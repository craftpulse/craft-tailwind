...
- Tailwind class prefix support (`prefix: 'tw-'`) for v3 projects, rebuilding the merge engine when the prefix changes.
- Out-of-the-box compatibility with `@tailwindcss/typography` — `prose-*` modifiers resolve through both v3 and v4 engines.
